...
@section('title' , __('models.edit_partner')  )
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">{{ __('models.edit_partner') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{ __('models.edit_partner') }}</h2>
                                </div>
                                <div class="card-body">
                                    <form class="form form-vertical needs-validation" id="createCustomerForm"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12 mb-3">
                                                <label for="mobile">{{ __('models.mobile') }}</label>
                                                    <input type="number" id="mobile" class="form-control" name="mobile"
                                                        value="{{ old('mobile' , $partner->mobile) }}" required/>
                                            ...
                                            <div class="col-md-6 col-12 mb-3">
                                                <label for="manager">{{ __('models.manager') }}</label>
                                                    <input type="text" id="manager" class="form-control" name="manager"
                                                        value="{{ old('manager' , $partner->manager ) }}" required/>
                                            ...
                                            <div class="col-md-6 col-12 mb-3">
                                                <label for="manager_mobile">{{ __('models.manager_mobile') }}</label>
                                                    <input type="number" id="manager_mobile" class="form-control" name="manager_mobile"
                                                        value="{{ old('manager_mobile', $partner->manager_mobile ) }}" required/>
                                            ...
                                            <div class="form-group prev">
                                                <img src="{{ asset('storage/'.$partner->img) }}" style="width: 100px" class="img-thumbnail preview-formFile" alt="">
                                            </div>
                                            ...
                                            <div class="form-group prev">
                                                <img src="{{ asset('storage/'.$partner->location_img) }}" style="width: 100px" class="img-thumbnail preview-location_img" alt="">
                                            </div>
                                            ...
                                            <div class="col-md-6 col-12 mb-3">
                                                <div class="custom-control custom-control-success custom-checkbox">
                                                    ...
                                                    <input type="checkbox" name="delivary" class="custom-control-input" value="1" id="delivary" {{ $partner->delivary  == 1 ? 'checked' : '' }}  />
                                            ...
                                            @foreach ($services as $service )
                                                ...
                                                <div class="col-md-6 col-12 mb-3">
                                                    <div class="custom-control custom-control-success custom-checkbox">
                                                        <input type="checkbox" name="service_id[]" class="custom-control-input" value="{{ $service->id }}" id="{{ $service->id }}" {{ $partner->services->contains('id' , $service->id) == 1 ? 'checked' : '' }} multiple/>
                                            ...
                                            <div class="col-md-12 col-12 mb-3">
                                                <div class="d-flex col-md-12 flex-column mb-7 fv-row fv-plugins-icon-container">
                                                        <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                                            ...
                                                            <input type="text"  name="icon"  class="form-control form-control-solid" id="searchInput" value="{{ old('location' ,$partner->location) }}" >
                                            ...
                                            <div class="col-md-12 col-12 mb-3">
                                                <div class="d-flex col-12 flex-column mb-7 fv-row fv-plugins-icon-container" style="height:100vh">
                                                    <input type="hidden" name="location" class="form-control" id="location"  value="{{ old('location' ,$partner->location) }}">
                                                    <input type="hidden" name="lat" class="form-control" id="lat"  value="{{ old('lat' ,$partner->lat) }}">
                                                    <input type="hidden" name="lng" class="form-control" id="lng"  value="{{ old('lng' ,$partner->lng) }}">
